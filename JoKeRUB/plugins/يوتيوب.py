...
async def _(event):
    ...
    async with bot.conversation(chat) as conv:
        try:
            ...
            await event.edit("** ✎┊‌ جارِ الحصول على الرد  | 20%**\n█▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒")
            await asyncio.sleep(1)
            await event.edit("** ✎┊‌ جارِ الحصول على الرد  | 30%**\n██▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒")
            await asyncio.sleep(1)
            await event.edit("** ✎┊‌ جارِ الحصول على الرد  | 40%**\n████▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒")
            await asyncio.sleep(1)
            await event.edit("** ✎┊‌ جارِ الحصول على الرد  | 50%**\n███████▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒")
            await asyncio.sleep(1)
            await event.edit("** ✎┊‌ جارِ الحصول على الرد  | 60%**\n███████████▒▒▒▒▒▒▒▒▒▒▒▒▒")
            await asyncio.sleep(1)
            await event.edit("** ✎┊‌ جارِ الحصول على الرد  | 70%**\n████████████████▒▒▒▒▒▒▒▒")
            await asyncio.sleep(1)
            await event.edit("** ✎┊‌ جارِ الحصول على الرد  | 80%**\n████████████████████▒▒▒▒")
            await asyncio.sleep(1)
            await event.edit("** ✎┊‌ جارِ الحصول على الرد  | 90%**\n██████████████████████▒▒")
            await asyncio.sleep(1)
            ...
            while True:
                ...
                if "𝗪𝗮𝗶𝘁 𝗺𝗲" not in response.text:
                    ...
                    await bot.delete_dialog(conv.chat_id, silent=True)
                    break
